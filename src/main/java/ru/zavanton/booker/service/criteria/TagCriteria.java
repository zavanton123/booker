...
/**
 * Criteria class for the {@link ru.zavanton.booker.domain.TagEntity} entity. This class is used
 * in {@link ru.zavanton.booker.web.rest.TagResource} to receive all the possible filtering options from
...
public class TagCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, slug, createdAt, bookTagId, distinct);
    }
