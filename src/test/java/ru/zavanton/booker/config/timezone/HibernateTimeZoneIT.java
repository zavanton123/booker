package ru.zavanton.booker.config.timezone;
...
import ru.zavanton.booker.repository.timezone.DateTimeWrapper;
import ru.zavanton.booker.repository.timezone.DateTimeWrapperRepository;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM booker_date_time_wrapper where id=%d", fieldName, id);
    }
